<?php
/**
 * Benchamrking suite for the json module of the PHP-XMLRPC lib
 * @author Gaetano Giunta
 * @version $Id: benchmark.php,v 1.4 2006/11/05 22:30:51 ggiunta Exp $
 ...
 **/
	...
	include_once(getcwd().'/parse_args.php');
	...
	@include_once(getcwd().'/Zend/Zend_Json.php'); // renamed file: a bit strange for everybody to use json.php isn't it?
