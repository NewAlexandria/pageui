...
jQuery.extend({
	...
	each: function( object, callback, args ) {
        ...
        // window.console.log(object.length)
		var name, i = 0, length = object.length;

		if ( args ) {
			if ( length == undefined ) {
				for ( name in object ) {
                    // window.console.log('here 2: ' +object + '\nlength: ' + length)
                    // if ( object.hasOwnProperty(name) )
					if ( callback.apply( object[ name ], args ) === false )
						break;
				}
			} else {
                // window.console.log('here 3: ' +object + '\nlength: ' + length)
				for ( ; i < length; )
		...
		// A special, fast, case for the most common use of each
			...
			if ( length == undefined ) {
                // window.console.log('here 4: ' +object + '\nlength: ' + length)
				for ( name in object )
                    // if ( object.hasOwnProperty(name) )
					    if ( callback.call( object[ name ], name, object[ name ] ) === false )
						    break;
			} else {
                // window.console.log('here 5: ' +object + '\nlength: ' + length)
...
// regex replace() in $.clean goes wonky in the bookmarklet on flickr when tags are properly closed using '/'
// mod to jquery below: add full closing tag 
					var elem = jQuery("<" + this.tagName + "><\/" + this.tagName + ">").appendTo("body");
