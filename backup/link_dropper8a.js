...
function addFrame() {
	...
	jQuery('#dropper_frame').load("http://www.pageui.com/test/link_dropper.php?URL="+encodeURIComponent(location.href)+"&title="+encodeURIComponent(parent.document.title));
	});
