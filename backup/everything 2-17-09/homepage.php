...
<tr>
	...
	<td id="frame_content">
		...
		<div id="accordion">
			...
			<div>
				You should just be able to <a href="javascript:this.style.behavior='url(#default#homepage)';this.setHomePage('http://www.pageui.com/edit.php');">click here to make PageUI your homepage</a>
