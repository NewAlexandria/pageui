...
//		$db = mysql_connect ("localhost", "dominavi", ")NLy1p@G3uiAT", false, 131074) or die ('We are currently experiencing a downtime.  Please feel free to inquire as to when the system will become available again. <br/><br/>' . mysql_error());
