...
function addFrame() {
	...
	jQuery('#dropper_frame').fadeOut(0, function () {
		jQuery("#dropper_frame").attr("style", "width:870px;height:140px;border:0;position:fixed;top:20px;left:5%;z-index:10000003;visibility:visible;display:block;min-width:640px;font-size:12px;");
